...
var menuLinks = [
  ...
  // NOTES: 
  // We can use "const" or "let" to declare the variable.
  ...
  // NOTES: 
  // Using the mainEl variable we created and 
  ...
  // NOTES: 
  // Using the mainEL variable and adding a property
...
mainEl.classList.add("flex-ctr");                                 // 1.3
  ...
  // 2.0 INSTRUCTION: Select and store the <nav id="top-menu"> 
  // element in a variable named topMenuEl. 

  // NOTES: 
  // Declare variable topMenuEl using const or let. The 
  // variable is set to the document object property by using 
  // "document"
  // .querySelector method checks the document for the first 
  // mention of "top-menu".
...
const topMenuEl = document.querySelector('#top-menu');            // 2.0
  ...
  // NOTES: 
  // Taking the topMenuEl variable and using the .style
...
topMenuEl.style.height = "100%";                                  // 2.1
  ...
  // NOTES: 
  // Using the topMenuEl variable and accessing the 
  // .style style object for the HTML document and changing 
  // the background color of the top menu element by using the 
  // property .backgroundColor and setting it by using the 
  // function var() and passing in the --top-menu-bg color 
  // that is set in the CSS root selector. The :root CSS selector 
  // refers back to the HTML root element. 

topMenuEl.style.backgroundColor = 'var(--top-menu-bg)';           // 2.2


  // 2.3 INSTRUCTION: Add a class of flex-around to 
  // topMenuEl element

  // NOTES: 
  // Using the topMenuEl variable and using 
  // the .add method of the classList property to add the 
  // class "flex-around" to the top menu. 

  // The top menu will now take on the properties
...
topMenuEl.classList.add('flex-around');                           // 2.3
  ...
  // 3.0 INSTRUCTION: Copy the following data structure to 
  // the top of script.js:

  // NOTES: updating the menuLinks array


  // 3.1.a INSTRUCTION: Iterate over the entire menuLinks array and 
  // for each "link" object: Create an <a> element */

  // NOTES: 
  // Looping over the elements of the array object 
  ...
  // NOTES: 
  // We're using the newATagEl element we declared
  ...
  // NOTES: 
  // We're taking the newATagEl element that we 
...
menuLinks.forEach(function (linkObject) {                         // 3.1a
  ...
  // 4.0 INSTRUCTION: Select and set/cache the 
  // <nav id="sub-menu"> element in a variable named subMenuEl.

  // NOTES: 
  // declaring a variable subMenuEL and
...
const subMenuEl = document.querySelector('#sub-menu');            // 4.0
  ...
  // NOTES: 
  // Taking the subMenuEl variable and using 
  // the .style style object it to add a height 
  // of 100% to the sub menu

subMenuEl.style.height = '100%';                                  // 4.1


  // 4.2 INSTRUCTION: Set the background color of subMenuEl 
  // to the value stored in the --sub-menu-bgCSS custom property.

  // NOTES: 
  // Using the subMenuEl element we created 
  // and accessing the .style style object for the HTML 
  // document and changing the background color of the 
  // sub menu element by using the property .backgroundColor
  // and setting it by using the function var() and 
  // passing in the --sub-menu-bg color that is set 
  // in the CSS root selector. 
...
subMenuEl.style.backgroundColor = 'var(--sub-menu-bg)';           // 4.2
  ...
  // 4.3 INSTRUCTION: Add the class of flex-around 
  // to the subMenuEl element.

  // NOTES: 
  // Taking the subMenuEl element 
  // that we created and using the .add method of 
  // the classList property to add the class 
  // "flex-around" to the sub menu. 

  // The sub menu will now take on the properties on 
  // the CSS style sheet under the .flex around class:
  // flex around{display:flex; justify-content:space-around; 
  // align-items: center;}
...
subMenuEl.classList.add("flex-around");                           // 4.3
  ...
  // 4.4 INSTRUCTION: Set the CSS position property 
  // of subMenuEl to the value of absolute.

  // NOTES: Using the subMenuEl element we 
  // created and accessing the .style style object for 
  // the HTML document and changing the position
  // by using the .style.position property and 
  // setting the position to absolute

  // SYNTAX: object.style.position = 
  //"static|absolute|fixed|relative|sticky|initial|inherit"
  // with absolute positioning, the element is positioned 
  // relative to it's first positioned ancestor element 
  // that's not static 
...
subMenuEl.style.position = 'absolute';                            // 4.4
  ...
  // NOTES: Using the subMenuEl element we created 
  // and accessing the .style style object for the HTML 
...
subMenuEl.style.top = '0';                                         // 4.5
  ...
  // NOTES: 
  // Declaring a variable topMenuLinks and 
...
let showingSubMenu = false;                                       // 5.1b
  ...
  // NOTES: HTML DOM allows JS to react to events.
  ...
  // NOTES: adding an IF statement to our function. 
  // IF the element clicked was not an <a> element,
...
// 6.0a INSTRUCTION: Attach a delegated 'click'
// event listener to subMenuEl

// 6.0b INSTRUCTION: The first line of code of the 
// event listener function should call the event 
// object's preventDefault()method.

// 6.0c INSTRUCTION: The second line of code function 
// should immediately return if the element clicked 
// was not an <a> element.

// 6.0d INSTRUCTION: console.log the content of the 
// <a> to verify the handler is working. 

// 6.1a INSTRUCTION: Next, the event listener should:
// 1. Set showingSubMenu to false.

// 6.1b INSTRUCTION: 2. Set the CSS top property 
// of subMenuEl to 0.

// 6.2 INSTRUCTION: Remove the class name of active 
// from each <a> element in topMenuLinks
// - whether the active class exists or not.

// 6.3 INSTRUCTION: Update the contents of mainEl to 
// the contents of the <a> element, within an <h1>, 
// clicked within subMenuEl.

// 6.4 INSTRUCTION: If the ABOUT link is clicked, 
// an <h1>about</h1> should be displayed
